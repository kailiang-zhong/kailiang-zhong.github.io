...
# 简介｜Intro
- 我是一个算法工程，主要从事于uplift建模/因果推断/推荐系统相关工作。现在在字节跳动（Btyedance）负责抖音支付用户增长/营销算法相关工作。 之前在阿里国际-Lazada负责各类优惠券营销算法/用户定价，再之前在腾讯负责直播推荐。
...
- 专利: 《[基于LPA算法对主播进行反作弊识别](http://epub.cnipa.gov.cn/patent/CN110196921A)》
